...
| ------------- | ---------- | --------------------------------------------------------------------------------------- | ---------------- | -------------- | ------------------------ | ------------------------------ |
| users         | Профиль    | id(16) + name(100) + email(100) + password_hash(250) + timestamps(16) = 382 Б           | 36 млн           | ≈ 18.7 ГБ      | Регистрация              | Чтение при заходе на странички |
| accounts      | Счета      | id(16) + user_id(16) + balance(16) + currency(10) + timestamps(16) + status(50) = 124 Б | 72 млн           | ≈ 5.7 ГБ       | 3 900 000 / 86400 ≈ 45   | 45                             |
| transactions  | Транзакции | id(16) + from/to(32) + amount(16) + status/type(40) + timestamps(16) = 120 Б            | 33 млрд          | ≈ 3.9 ТБ       | 45                       | 1 950 000 / 86400 = 23         |
| credits       | Кредиты    | id(16) + user_id(16) + amount(16) + status(20) + ts(16) = 84 Б                          | 180 млн          | ≈ 16.2 ГБ      | 39 000 / 86400 = 0.5     | 1                              |
| notifications | Push-ув-ия | id(16) + user_id(16) + payload(2000) + status/timestamps(52) ≈ 2 КБ                     | 20 млрд          | ≈ 80 ТБ        | 45                       | 45                             |
